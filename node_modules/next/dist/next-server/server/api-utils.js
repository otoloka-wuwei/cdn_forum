...
function apiResolver(req, res, params, resolverModule, apiContext, onError) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // // Parsing of body
            if (bodyParser) {
                apiReq.body = yield parseBody(apiReq, config.api && config.api.bodyParser && config.api.bodyParser.sizeLimit
...
function parseBody(req, limit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let buffer;
        try {
            buffer = yield raw_body_1.default(req, { encoding, limit });
        }
        catch (e) {
